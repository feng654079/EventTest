...
struct ConfirmPublishAnimationControllerGenerator :AnimatedTransitioningGenerator{
...
class ConfirmPublishAnimationController : DefaultAnimator {
    ...
    override func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        //let viewSize = CGSize(width: 300.hs, height: 335)
